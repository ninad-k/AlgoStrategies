...
#    3. .\deploy_windows.ps1 -BotToken "YOUR_TELEGRAM_BOT_TOKEN"
#
#  Recommended specs:
...
& "$venvDir\Scripts\pip.exe" install -e "$teleDir[telegram]"
Write-OK "TeleTrader + dependencies installed"
...
echo.
"$venvDir\Scripts\python.exe" -m teletrader.telegram.bot
...
Write-Host ""
Write-Host "  SIGNAL FORMAT (send via Telegram):" -ForegroundColor Cyan
Write-Host "    XAUUSD Buy Above 2350" -ForegroundColor White
Write-Host "    SL 2330" -ForegroundColor White
Write-Host "    Target 2360 2370 2390" -ForegroundColor White
Write-Host ""
